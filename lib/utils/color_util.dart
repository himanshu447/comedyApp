...
class AppColor {
  static const Map<int, Color> primary_blue = const <int, Color>{
    ...
    300: const Color(0xFFC1C3FB),
    400: const Color(0xFFB2B4FA),
  ...
  static const Map<int, Color> primary_green = const <int, Color>{
    ...
    300: const Color(0xFFABEBDF),
    400: const Color(0xFF96E6D7),
  ...
  static const Map<int, Color> primary_pink = const <int, Color>{
    ...
    300: const Color(0xFFFDC7C7),
    400: const Color(0xFFFDB9BA),
  ...
  static const Color waiting = Color(0xFFFFB643);
  static const Color links = Color(0xFF1B7CF8);

...
class NumberSelectionSwiper extends StatefulWidget {
  const NumberSelectionSwiper({
    Key key,
  ...
  @override
  _NumberSelectionSwiperState createState() => _NumberSelectionSwiperState();
}

class _NumberSelectionSwiperState extends State<NumberSelectionSwiper>
      ...
      res.add(GestureDetector(
        ...
        child: Padding(
          ...
          child: Opacity(
            ...
            child: CircleAvatar(
              radius: 30,
              backgroundColor: AppColor.primary_orange[100],
              child: Text(
                text,
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Stack(
          children: <Widget>[
            Head(
              color: AppColor.primary_orange[50],
              hasShadow: true,
            ),
            /*Opacity(
